        ...
        body: SingleChildScrollView(
          ...
          children: [
            Padding(
              ...
              child: Center(
                child: Text(
                  "Tap on the below screen to trace a square.\nIf tapped outside the figure boundaries, an alarm buzzes and vibrates.",
            ...
            Padding(
              ...
              child: Stack(
                children: [
                  InkWell(
                    onTap: () async {
                      player.play('BEEP.wav'); // will immediately start playing
